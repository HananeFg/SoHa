...
<body>
  ...
  <br><br><br>
    ...
    <div class="sidebar">
      ...
      <button class="sidebar-button" onclick="toggleActive(this)" style="background-color: #fcdc5b"><i class="fas fa-users fa-x2"></i>Clients</button>
      <button class="sidebar-button" onclick="toggleActive(this)"><i class="fas fa-file fa-x2"></i>Reports</button>
        ...
        <tr>
            ...
            <td>
              <form id="deleteForm-{{$client->id }}" action="{{route('clients.destroy', $client->id)}}"  method="post">
                  ...
                  <button  class="btn btn-danger" type="button" data-toggle="modal" data-target="#confirmationModal" data-form-id="deleteForm-{{ $client->id }}">
